...
if __name__ == '__main__':
    ...
    with SyncCrazyflie(URI, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        with MotionCommander(scf) as mc:
            ...
            mc.right(0.4, velocity=0.8)
            time.sleep(1)
            mc.left(0.4, velocity=0.4)
            time.sleep(1)

            # We can do circles or parts of circles
            mc.circle_right(0.2, velocity=0.5, angle_degrees=180)
            ...
            mc.move_distance(-1, 0.0, 0.2, velocity=0.6)
            time.sleep(1)
            ...
            # We directly land when the MotionCommander goes out of scope